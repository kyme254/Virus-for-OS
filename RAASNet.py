...
class Login(Tk):
    def __init__(self):
        ...
        if platform.system() == 'Linux':
            photo = Image.open('images/index.jpeg')
            ...
            photo = PIL.Image.open('images/index.jpeg')
    ...
    def contact(self):
        ...
        if platform.system() == 'Linux':
            ...
            photo = PIL.Image.open(resource_path('images/incsec_full.jpg'))
        ...
        Label(self.contact, text = '@Kimtechsonko', background = 'white').grid(row = 1, column = 1, sticky = 'w')

        Label(self.contact, text = 'LinkedIn: ', background = 'white').grid(row = 2, column = 0, sticky = 'w')
        Label(self.contact, text = 'Kimtech', background = 'white').grid(row = 2, column = 1, sticky = 'w')

        Label(self.contact, text = 'GitHub: ', background = 'white').grid(row = 3, column = 0, sticky = 'w')
        Label(self.contact, text = 'kyme254', background = 'white').grid(row = 3, column = 1, sticky = 'w')

        Label(self.contact, text = 'Email: ', background = 'white').grid(row = 4, column = 0, sticky = 'w')
        Label(self.contact, text = 'info@kimtechsoftwaresolutions.co.ke', background = 'white').grid(row = 4, column = 1, sticky = 'w')
...
Please visit: https://kimtechsoftwaresolutions.co.ke and search for your IP/hostname to get your key.
...
vV4t+0UE/G5fAN2ccz9Ug6PdAAAAAElFTkSuQmCC''')
        ...
        if platform.system() == 'Linux':
            photo = Image.open(resource_path('images/logo2.jpg'))
            resized = photo.resize((150,150), Image.ANTIALIAS)
            photo = ImageTk.PhotoImage(resized)
        else:
            photo = PIL.Image.open(resource_path('images/logo2.jpg'))
        ...
        Label(self, text = 'Kimtech Virus ', background = 'white', foreground = 'red', font='papyrus 32 bold').grid(row = 1, column = 0)
    ...
    def profile(self):
        ...
        if platform.system() == 'Linux':
            photo = Image.open(resource_path('images/incsec_full.jpg'))
            resized = photo.resize((350,150), Image.ANTIALIAS)
            photo = ImageTk.PhotoImage(resized)
        else:
            photo = PIL.Image.open(resource_path('images/incsec_full.jpg'))
    ...
    def run_server(self):
        ...
        if platform.system() == 'Linux':
            photo1 = Image.open(resource_path('images/windows.jpeg'))
            resized = photo1.resize((100,100), Image.ANTIALIAS)
            photo1 = ImageTk.PhotoImage(resized)
        else:
            photo1 = PIL.Image.open(resource_path('images/windows.jpeg'))
